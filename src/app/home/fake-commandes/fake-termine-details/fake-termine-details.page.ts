...
@Component({
  selector: 'app-fake-termine-details',
  templateUrl: './fake-termine-details.page.html',
  styleUrls: ['./fake-termine-details.page.scss'],
})
export class FakeTermineDetailsPage implements OnInit {
  client: Client;
